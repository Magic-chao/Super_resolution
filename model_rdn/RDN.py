...
class RDN(nn.Module):
    def __init__(self, args):
        ...
        # Upsampler
        self.conv_up1 = nn.Conv2d(nFeat, nFeat * 4, kernel_size=3, padding=1, bias=True)
        # self.conv_up2 = nn.Conv2d(8 * nFeat, nFeat * 64, kernel_size=3, padding=1, bias=True)
        self.upsample = sub_pixel(2)
        # conv
